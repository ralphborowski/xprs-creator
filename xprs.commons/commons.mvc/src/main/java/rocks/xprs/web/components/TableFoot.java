 ...
 */
public class TableFoot extends GroupView {

  @Override
  public TableFoot addView(View view) {
    super.addView(view);
    return this;
  }

  @Override
  public TableFoot addView(String name, View view) {
    super.addView(name, view);
    return this;
  }

  @Override
  public TableFoot removeView(View view) {
  ...
  public HtmlNode render() {
    HtmlElement baseElement = new HtmlElement("tfoot");
