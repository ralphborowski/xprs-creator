 ...
 */
public class ToCanonicalDescriptorClassNameMethod implements TemplateMethodModelEx {
    ...
    if (!arguments.isEmpty()) {
      ...
      if (arguments.get(0) instanceof StringModel) {
        ...
        if (wrappedObject instanceof Project) {
          ...
          return project.getBasePackage() + "." + ToSimpleDescriptorClassNameMethod.getSimpleClassName(project);
        } else {
